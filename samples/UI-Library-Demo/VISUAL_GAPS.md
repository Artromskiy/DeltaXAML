...
| Dashed stroke and inset shadow | Public `BorderWidth` is a scalar solid stroke; no dash pattern or CSS inset-shadow authoring. | Empty-state boxes use solid outlines; the very subtle card inset highlight is omitted. |
