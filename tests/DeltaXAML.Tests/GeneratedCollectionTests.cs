...
internal static class GeneratedCollectionTests
{
    internal static void Run()
    {
        ...
        Assert.Equal("One:False", ((UiTextBlock)collection.ItemsHost.Children[0]).Text, "generated item plan performs a direct typed multi-source read");
        ...
        Assert.Equal("Two", ((UiTextBlock)collection.ItemsHost.Children[1].Children[0]).Text, "generated selector template preserves typed item binding");
    }
}
