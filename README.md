...
- [INTERNAL.md](INTERNAL.md) — retained implementation notes, not an API;
- [TODO.md](TODO.md) — selected migration work;
...
The canonical cross-project namespace is `Delta.XAML.Contract`; the previous
